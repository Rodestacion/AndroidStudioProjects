...
import com.example.apexercise6.databinding.ActivityDrivingQuestion4Binding

class DrivingQuestion4 : AppCompatActivity() {
    private lateinit var binding: ActivityDrivingQuestion4Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDrivingQuestion4Binding.inflate(layoutInflater)
        ...
        binding.btnNext.setOnClickListener {
            ...
            if(binding.radGroupAnswer.checkedRadioButtonId<0){
                ...
                val nextScreen = Intent(this, DrivingQuestion5::class.java)
